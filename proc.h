...
struct	pentry	{
	...
	int	pwaitret;
	int intervalLeft;	//quantum left
        int intervalTime;	//quantum assumed=10
        int waitFactor;	//priotity + sved interval = goodness or wait Factor
        int stateProc;	// normal poc or real-time process
};
